...
const ProductController = {
    ...
    updateProduct: async (req, res)=>{
        ...
        ProductoModel.updateOne({_id:product_id},{$set:{productToUpdate}})
        .then((productUpdated)=>{
    ...
    deleteProduct: async (req, res)=>{
        ...
        ProductoModel.deleteOne({_id:product_id})
        .then((productDeleted)=>{
            ...
            // Producto eliminado
            return res.status(201).send({productDeleted:productDeleted});
    ...
    createMultipleProducts:(req,res)=>{
        ...
        ProductoModel.insertMany(products)

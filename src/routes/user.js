...
router.patch('/change-password/:email/:password', [authJwt.verifyToken, authJwt.isUser, token.generateChangePasswordToken, token.checkPasswordToken], userController.resetPasswordByEmail);
